...
class DatabaseConnection {
  ...
  // update schema every 15s
  private static final long SCHEMA_UPDATE_INTERVAL_MS = 15000;
...
*/
  ...
  class Schema {
    ...
    Map<String, Map<String, Set<String>>> getSchema2tables() {
      ...
      long nextUpdate = System.currentTimeMillis() + SCHEMA_UPDATE_INTERVAL_MS;
      schemaNextUpdate = new Timestamp(nextUpdate);
      return schema2tables;
    }
